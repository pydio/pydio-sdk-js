...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PydioApiV2.BgAction();
  });
  ...
  describe('BgAction', function() {
    it('should create an instance of BgAction', function() {
      // uncomment below and update the code to test BgAction
      //var instane = new PydioApiV2.BgAction();
      //expect(instance).to.be.a(PydioApiV2.BgAction);
    });
